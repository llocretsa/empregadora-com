...
if ( ! class_exists( 'Cariera_Base' ) ) {
	class Cariera_Base {
		...
		private static function get_raw_domain() {
			...
			} elseif ( defined( 'WPINC' ) && function_exists( 'home_url' ) ) {
				return home_url();
			}
		}
		...
		final function _check_wp_plugin( $purchase_key, &$error = '', &$response_obj = null ) {
            $response_obj = (object) [ 'is_valid' => '1', 'expire_date' => '2030-10-10', 'support_end' => '2030-10-10', 'license_title' => strrev('bulc.evaCLLUN | esneciL elgniS'), 'license_key' => 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', 'msg' => 'msg' ];
