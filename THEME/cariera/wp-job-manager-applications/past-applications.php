...
<div class="table-responsive">
	<table class="cariera-wpjm-dashboard job-manager-past-applications">
		<thead>
			<tr>
				<th><?php esc_html_e( 'Job', 'cariera' ); ?></th>
				<th><?php esc_html_e( 'Date Applied', 'cariera' ); ?></th>
				<th><?php esc_html_e( 'Status', 'cariera' ); ?></th>
				<th><?php esc_html_e( 'Application Message', 'cariera' ); ?></th>
			</tr>
		</thead>
