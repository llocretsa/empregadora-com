...
class Cariera_Job_Search extends Widget_Base {
	...
	protected function render() {
		...
		// Form.
		$output = '<form method="GET" action="' . esc_url( get_permalink( get_option( 'job_manager_jobs_page_id' ) ) ) . '" class="job-search-form ' . $settings['search_style'] . ' ' . $settings['custom_class'] . '">
