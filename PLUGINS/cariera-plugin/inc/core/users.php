...
class Cariera_Core_Users {
	...
	public function forgetpass_form() {
		...
		<form id="cariera_forget_pass" method="post">
			...
			if ( class_exists( 'Cariera_Recaptcha' ) && Cariera_Recaptcha::is_recaptcha_enabled() && $forgotpass_captcha ) {
				?>
				<div class="form-group">
	...
	public function login_process() {
		...
		if ( class_exists( 'Cariera_Recaptcha' ) && Cariera_Recaptcha::is_recaptcha_enabled() && $login_captcha ) {
			$is_recaptcha_valid = array_key_exists( 'g-recaptcha-response', $_POST ) ? Cariera_Recaptcha::is_recaptcha_valid( sanitize_text_field( wp_unslash( $_POST['g-recaptcha-response'] ) ) ) : false;
	...
	public function my_profile() {
		...
		$template_loader->get_template_part( 'account/my-profile' );
	}
	...
	public function user_dashboard() {
		...
		$template_loader->get_template_part( 'account/dashboard' );
	}
}
