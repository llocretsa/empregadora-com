...
if ( ! is_user_logged_in() ) { ?>
	...
	// Dashboard Cards.
	$template_loader->get_template_part( 'account/dashboard/cards' );
	?>
	...
	<div class="row mt50">
		...
		$template_loader->get_template_part( 'account/dashboard/views-charts' );

		// Dashboard Active Packages.
		$template_loader->get_template_part( 'account/dashboard/active-packages' );
		?>
	</div>
	<?php
}
